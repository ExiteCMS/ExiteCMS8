...
$formdata['form_template'] = str_replace('{info}', \Lang::get('action.add.info'), $formdata['form_template']);
$formdata['form_template'] = str_replace('{header}', \Lang::get('action.add.form'), $formdata['form_template']);
...
// create the fieldset
$fieldset = Fieldset::forge('user')->set_config($formdata)->add_model($model)->repopulate();
