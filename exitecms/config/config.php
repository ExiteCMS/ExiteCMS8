...
return array(
	...
	'errors'  => array(
		...
		'continue_on'  => Fuel::$env == 'development' ? array(E_NOTICE, E_WARNING, E_DEPRECATED, E_STRICT) : array(),
		// How many errors should we show before we stop showing them? (prevents out-of-memory errors)
		'throttle'     => 10,
		// Should notices from Error::notice() be shown?
		'notices'      => Fuel::$env == 'development' ? true : false,
	),
